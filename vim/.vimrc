 ...
 "
 " key map
 " <C-...> Control Key + anykey
 " <D-...> Command Key + anykey-------> for mac 's terminal can not use
 " <S-...> Shift key   + anykey
 " <A-...> Alt key     + anykey------> <a-e> function is <a-a> usable only 
 "ctrl + e で展開
...
" let g:user_emmet_prev_key = '<S-TAB>'
 let g:user_emmet_settings = {
    ...
    \  }
"-------------------------------------------------------------------
"spaceキー+.で設定ファイルをすぐ編集できる様にする
nnoremap <Space>. :<C-u>edit $MYVIMRC<Enter>
nnoremap <Space>z :<C-u>edit $HOME/.zshrc<Enter>
nnoremap <Space>s. :<C-u>source $MYVIMRC<Enter>
nnoremap <Space>z. :<C-u>!source $HOME/.zshrc<Enter>

"------------------------------------------------------------
"画面分割移動をCTLキーからsキーへ変更する
"また画面配置変更に併せてサイズも最適化する
...
"------------------------------------------------------------
"ノーマルモードで空行を挿入する　大文字のKにマッピング
nnoremap K k:<C-u>call append(expand('.'), '')<Cr>j
